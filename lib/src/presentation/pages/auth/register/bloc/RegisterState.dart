...
class RegisterState extends Equatable{
  ...
  const RegisterState({
    ...
    this.phone = const BlocFormItem(error: "Ingrese el nombre"),
    this.password = const BlocFormItem(error: "Ingrese el Contrasenia"),
    this.confirmPassword = const BlocFormItem(error: "Ingrese el Contrasenia"),
    this.formKey ,
    this.response
